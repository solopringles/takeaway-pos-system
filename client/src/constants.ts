...
export const SET_MEALS = [
    ...
    { id: 'B', name: 'Set Meal B', size: '2 人餐', price: 24.00 },
    { id: 'C', name: 'Set Meal C', size: '3 人餐', price: 33.00 },
    { id: 'D', name: 'Set Meal D', size: '4 人餐', price: 47.00 },
    { id: '1a', name: '1/4 Aromatic Duck', size: '1/4 甲', price: 9.60 },
    { id: '1b', name: '1/2 Aromatic Duck', size: '1/2 甲', price: 18.00 },
